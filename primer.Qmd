...
- A description of devices available is given in Ch. 9, “Mechanical thrombectomy technique”.  
**\
...
- Descriptions of common devices are given in Ch. 8, “Intrasaccular devices”.
...
- Toxicity. Cyanoacrylates can cause toxic tissue damage due to the exothermic polymerisation reaction and release of compounds such as acryl acetate and formaldehyde. Perioperative corticosteroids are sometimes used to ameliorate these effects. 
  ...
  **Figure 4.1: Glue partial embolisation of AVM. (A) A large parietal AVM is identified, with multiple feeders. (B) A Magic 1.5 microcatheter was navigated into one of the feeders. Initial microangiography identifies the AVM, but the Magic is seen to be folded back on itself. (C) The microcatheter is straightened by tugging it gently with the wire in place. (D) Injection of glue under fluoroscopy roadmap. (E) Unsubtracted exposure showing final glue cast after a second injection. (F) Final angiography revealing reduction in the posterior compartment of the AVM. Alt text: N/A.** 
**\
